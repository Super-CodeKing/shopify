...
import { setButtonSettings, setInheritFromTheme } from "../../store/reducers/ComingSoon";
...
export default function ColorNText() {
    ...
    const buttonSettingsRedux = useSelector((state) => state.comingsoon.buttonSettings);
    const inheritFromThemeRedux = useSelector((state) => state.comingsoon.inheritFromTheme);
